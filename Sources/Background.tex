...
but it only try to instantiate monotypes like HM.
Therefore, OL extends HM in a conservative way, such that
...
In other words, it is the typing rules that helps the type system to reason about
higher-ranked types, without actually complicates the type inference algorithm.
