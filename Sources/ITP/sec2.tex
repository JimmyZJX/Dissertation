...
are a notable different to older type-inference algorithms~\citep{damas1982principal} that use global
...
\jimmy{TODO perhaps a figure with the algorithmic rules that we use in this and other examples}
